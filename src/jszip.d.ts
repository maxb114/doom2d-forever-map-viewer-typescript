...
interface JSZip {
  ...
  /**
     ...
     */
  file: ((path: string) => JSZip.JSZipObject | null) & ((path: RegExp) => JSZip.JSZipObject[]) & (<T extends JSZip.InputType>(path: string, data: InputByType[T] | Promise<InputByType[T]>, options?: JSZip.JSZipFileOptions) => this) & (<T extends JSZip.InputType>(path: string, data: null, options?: JSZip.JSZipFileOptions & { dir: true }) => this);
